    ...
    _about(_("About..."))
{
    ...
    set_title("MATE Eiciel");
    set_border_width(4);

    set_default_icon_name("mate-eiciel");
...
#else
    gtk_show_uri(this->get_screen()->gobj(), "help:mate-eiciel", GDK_CURRENT_TIME, &error);
#endif
    if (error != NULL)
    {
...
#endif
    _title("<span size=\"xx-large\"><b>MATE Eiciel " PACKAGE_VERSION "</b></span>"),
    _author("<small>Copyright © 2017 Joel Barrios</small>\n<small>Copyright © 2004-2005 Roger Ferrer Ibáñez</small>")
{
    set_border_width(4);
